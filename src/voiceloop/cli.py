...
from voiceloop.factory import create_pipeline
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        choices=("stub", "live"),
        default="stub",
        help="Pipeline mode: stub (default) or live components",
    )
    ...
    pipeline = create_pipeline(args.mode)  # type: ignore[arg-type]
